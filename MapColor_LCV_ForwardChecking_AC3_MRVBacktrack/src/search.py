...
class EightPuzzle(Problem):
    ...
    def hManhattan(self, node):
        ...
        #START DEBUG TRACKING OF VARIABLES
#         nodeState = node.state
#         selfGoal = self.goal
#         zipStateGoal = zip(nodeState, selfGoal)
#         returnIs = sum(s != g for (s, g) in zipStateGoal)
        #END DEBUG TRACKING OF VARIABLES
         
        #MANHATTAN DISTANCE RET
